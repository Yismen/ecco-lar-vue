...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command('dainsys:capillus-pull-daily-performance-data')->dailyAt('05:45')
        ->timezone('America/New_York');
        $schedule->command('dainsys:capillus-send-agent-report')->dailyAt('05:55')->timezone('America/New_York');
        $schedule->command('dainsys:capillus-send-daily-performance-report')->dailyAt('06:00')
        ->timezone('America/New_York');
