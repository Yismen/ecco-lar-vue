...
@section('content')
  <div class="container-fluid">
    ...
    <div class="resume">
        ...
        <h1 class="page-title">Yismen Jorge</h1>
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="col-xs-12 col-sm-8">
                  <ul class="list-group">
                    <li class="list-group-item">Yismen Jorge</li>
                    <li class="list-group-item">Project Manager</li>
                    <li class="list-group-item">Ecco Outsourcing Group</li>
                    <li class="list-group-item"><i class="fa fa-phone"></i> 829-521-3304 </li>
                    <li class="list-group-item"><i class="fa fa-envelope"></i> yismen.jorge@gmail.com </li>
                  </ul>
                </div>
              </div>
            </div>
