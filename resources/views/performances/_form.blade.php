...
<div class="row">
    <div class="col-sm-6">
        ...
        <div class="form-group {{ $errors->has('login_time') ? 'has-error' : null }}">
            {!! Form::label('login_time', ' Login Time:', ['class'=>'col-sm-2 control-label']) !!}
            <div class="col-sm-10">
    ...
    <div class="col-sm-6">
        ...
        <div class="form-group {{ $errors->has('production_time') ? 'has-error' : null }}">
            {!! Form::label('production_time', ' Production Time:', ['class'=>'col-sm-2 control-label']) !!}
            <div class="col-sm-10">
    ...
    <div class="col-sm-6">
        ...
        <div class="form-group {{ $errors->has('transactions') ? 'has-error' : null }}">
            {!! Form::label('transactions', ' Sales:', ['class'=>'col-sm-2 control-label']) !!}
            <div class="col-sm-10">
    ...
    <div class="col-sm-6">
        ...
        <div class="form-group {{ $errors->has('revenue') ? 'has-error' : null }}">
            {!! Form::label('revenue', ' Revenue:', ['class'=>'col-sm-2 control-label']) !!}
            <div class="col-sm-10">
