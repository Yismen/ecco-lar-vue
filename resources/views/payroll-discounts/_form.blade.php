...
<div class="col-sm-12">
   ...
   <div class="col-sm-8">
       <div class="form-group {{ $errors->has('employee_id') ? 'has-error' : null }}">
           ...
           <div class="col-sm-10">
               {!! Form::select('employee_id', $discount->employeesList, null, ['class'=>'form-control input-sm']) !!}
...
<div class="col-sm-12">
   <!-- Amount -->
   <div class="col-sm-6">
       <div class="form-group {{ $errors->has('discount_amount') ? 'has-error' : null }}">
           {!! Form::label('discount_amount', 'Amount:', ['class'=>'col-sm-2 control-label']) !!}
           <div class="col-sm-10">
               {!! Form::input('number', 'discount_amount', null, ['class'=>'form-control', 'placeholder'=>'Amount']) !!}        
               {!! $errors->first('discount_amount', '<span class="text-danger">:message</span>') !!}
           </div>
       </div>
   </div>
   <!-- /. Amount -->
   ...
   <div class="col-sm-6">
       <div class="form-group {{ $errors->has('concept_id') ? 'has-error' : null }}">
           ...
           <div class="col-sm-10">
               {!! Form::select('concept_id', $discount->conceptsList, null, ['class'=>'form-control input-sm']) !!}
               {!! $errors->first('name', '<span class="text-danger">:message</span>') !!}
           </div>
       </div>
   </div>
