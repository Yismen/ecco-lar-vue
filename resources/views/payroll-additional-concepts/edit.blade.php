        ...
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2">
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        {!! Form::model($concept, ['route'=>['admin.payroll-additional-concepts.update', $concept->id], 'method'=>'PUT', 'class'=>'form-horizontal', 'role'=>'form', 'autocomplete'=>"off",  'enctype'=>"multipart/form-data"]) !!}       
