...
},{"./components/CreatePassword.vue":8,"./components/Password.vue":9,"./config/interceptors.js":11,"vue":5,"vue-resource":3,"vue-router":4}],8:[function(require,module,exports){
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n    <h3 class=\"page-header\" _v-46658bae=\"\">\n        Create New Password \n        <a href=\"#\" v-link=\"{path:'/'}\" class=\"pull-right\" _v-46658bae=\"\">\n            <i class=\"fa fa-list\" _v-46658bae=\"\"></i>\n        </a>\n    </h3>\n\n    <form action=\"\" method=\"POST\" class=\"form-horizontal\" role=\"form\" _v-46658bae=\"\">\n            <div class=\"form-group\" _v-46658bae=\"\">\n                <legend _v-46658bae=\"\">Form title</legend>\n            </div>\n    \n            \n    \n            <div class=\"form-group\" _v-46658bae=\"\">\n                <div class=\"col-sm-10 col-sm-offset-2\" _v-46658bae=\"\">\n                    <button type=\"submit\" class=\"btn btn-primary\" _v-46658bae=\"\">Submit</button>\n                </div>\n            </div>\n    </form>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "f:\\wamp\\www\\dainsys3\\resources\\assets\\js\\passwords\\components\\CreatePassword.vue"
...
exports['default'] = {
    ...
    methods: {
        createPassword: function createPassword(manage) {
            console.log('create', manage);
            return this.creating = true;
        },

        editPassword: function editPassword(object) {
...
module.exports = exports['default'];
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n    <div class=\"table-responsive\" _v-3803f85c=\"\">\n        <h4 class=\"page-header\" _v-3803f85c=\"\">\n            Passwords Management \n            <a href=\"#\" v-link=\"{path:'/create'}\" class=\"pull-right\" title=\"Create Password\" _v-3803f85c=\"\">\n                <i class=\"fa fa-plus\" _v-3803f85c=\"\"></i>\n            </a> \n        </h4>\n        <div v-if=\"passwords.length > 0\" _v-3803f85c=\"\">\n            <div v-for=\"password in passwords\" _v-3803f85c=\"\">\n                <password-item :item=\"password\" _v-3803f85c=\"\"></password-item>                                       \n            </div>\n        </div>\n        <div v-else=\"\" _v-3803f85c=\"\">\n            <div class=\"alert\" _v-3803f85c=\"\">\n                <h3 _v-3803f85c=\"\">Nothing saved yet. Please add some passwords.</h3>\n            </div>\n        </div>\n    </div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "f:\\wamp\\www\\dainsys3\\resources\\assets\\js\\passwords\\components\\Password.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n"] = false
    document.head.removeChild(__vueify_style__)
  })
...
},{"./PasswordItem.vue":10,"vue":5,"vue-hot-reload-api":2,"vueify-insert-css":6}],10:[function(require,module,exports){
var __vueify_style__ = require("vueify-insert-css").insert("\n    .toggler[_v-5b00f485] {\n        cursor: pointer;\n    }\n")
'use strict';
...
exports['default'] = {
  ...
  methods: {
    togglePassword: function togglePassword() {
      return this.vissible = !this.vissible;
    }
  },
...
module.exports = exports['default'];
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n    <!-- <div v-for=\"i in item\"> {{ i | json }} </div > -->\n    <div class=\"col-sm-6\" _v-5b00f485=\"\">\n         <div class=\"panel panel-default\" _v-5b00f485=\"\">\n            <div class=\"panel-body\" _v-5b00f485=\"\">\n                <strong _v-5b00f485=\"\">Site: </strong><a href=\"{{ item.url }}\" target=\"_new\" _v-5b00f485=\"\">{{ item.title }}</a> \n                <a href=\"\" @click.prevent=\"editPassword(item)\" class=\"text-warning pull-right\" _v-5b00f485=\"\"> <i class=\"fa fa-pencil\" _v-5b00f485=\"\"></i> </a>\n                <br _v-5b00f485=\"\">\n                <strong _v-5b00f485=\"\">User Name: </strong>{{ item.username }} <br _v-5b00f485=\"\">\n                <strong _v-5b00f485=\"\">Password: </strong><span v-show=\"vissible\" _v-5b00f485=\"\">{{ item.password }}</span> <a @click=\"togglePassword\" class=\"toggler\" _v-5b00f485=\"\"><i class=\"fa fa-eye\" _v-5b00f485=\"\"></i></a>\n                <!-- <label for=\"\">Password: </label><input type=\"password\" value=\"{{ item.password }}\"> -->\n            </div>\n        </div>\n    </div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "f:\\wamp\\www\\dainsys3\\resources\\assets\\js\\passwords\\components\\PasswordItem.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n    .toggler[_v-5b00f485] {\n        cursor: pointer;\n    }\n"] = false
    document.head.removeChild(__vueify_style__)
  })
