...
exports['default'] = {
    ...
    template: require('./nba.template.html'),
    ...
    methods: {
        ...
        fetchEmployees: function fetchEmployees() {
            ...
            return this.$http.get('api/employees').then(function (success) {
        ...
        deleteEmployee: function deleteEmployee(employee) {
            return this.$http['delete']('api/employees/' + employee.id).then(function (data) {
...
},{"./nba.template.html":30}],30:[function(require,module,exports){
...
},{"./test.template.html":32}],32:[function(require,module,exports){
module.exports = '<h3>Lorem Ipsum</h3>\n\n\n<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>';
  ...
  response: function response(_response) {
    ...
    switch (_response.status) {
      ...
      case 401:
        ...
        this.response_errors.push(_response.statusText);
        break;
...
new Vue({
  ...
  components: {
    nba: require('./components/nba/Nba.js'),
    test: require('./components/test/Test.js'),
    tasks: require('./components/Task.vue')
  },
...
},{"./components/Task.vue":28,"./components/nba/Nba.js":29,"./components/test/Test.js":31,"vue":27,"vue-resource":16}]},{},[33]);
