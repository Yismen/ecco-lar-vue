...
module.exports = exports['default'];
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n    <div class=\"table-responsive\" _v-3803f85c=\"\">\n        <form id=\"pss-form\" _v-3803f85c=\"\">\n            \n            <div class=\"form-group\" _v-3803f85c=\"\">\n                <label for=\"\" _v-3803f85c=\"\"> {{ manage }} </label>\n                <input type=\"text\" name=\"dime\" v-model=\"manage\" _v-3803f85c=\"\">\n            </div>\n            <div class=\"form-group\" _v-3803f85c=\"\">\n                <button v-if=\"creating == true\" type=\"submit\" class=\"btn btn-primary\" @click.prevent=\"createPassword(manage)\" _v-3803f85c=\"\">SAVE</button>\n                <button v-else=\"\" type=\"submit\" class=\"btn btn-success\" @click.prevent=\"editPassword(manage)\" _v-3803f85c=\"\">UPDATE</button>\n            </div>\n        </form>\n\n        <hr _v-3803f85c=\"\">\n        <password-item :item=\"{{ password }}\" _v-3803f85c=\"\"></password-item><table class=\"table table-condensed table-bordered table-striped\" _v-3803f85c=\"\">\n            <thead _v-3803f85c=\"\">\n                <tr _v-3803f85c=\"\">\n                    <th _v-3803f85c=\"\">System</th>\n                    <th _v-3803f85c=\"\">Username</th>\n                    <th _v-3803f85c=\"\">Password</th>\n                    <!-- <th><a href=\"/create\" @click.prevent=\"createPassword\"><i class=\"fa fa-plus\"></i> Add</a></th> -->\n                    <th _v-3803f85c=\"\"><a href=\"#\" v-link=\"{path:'/create'}\" _v-3803f85c=\"\"><i class=\"fa fa-plus\" _v-3803f85c=\"\"> Add</i></a></th>\n                </tr>\n            </thead>\n            <tbody _v-3803f85c=\"\">\n                <tr v-for=\"password in passwords\" _v-3803f85c=\"\">\n                                          \n                </tr>\n            </tbody>\n        </table>\n\n        <!-- <pre>{{ $data | json }}</pre> -->\n    </div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
module.exports = exports['default'];
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<pre _v-5b00f485=\"\">{{ item }}</pre>\n    <!-- <td><a href=\"{{ item.url }}\">{{ item.title }}</a></td>\n    <td>{{ item.username }}</td>\n    <td>{{ item.password }}</td>\n    <td>\n        <a href=\"\" @click.prevent=\"editPassword(item)\">\n            <i class=\"fa fa-pencil\"></i>\n        </a>\n    </td> -->\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
